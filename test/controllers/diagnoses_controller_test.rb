...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { appointment_id: @diagnosis.appointment_id, disease: @diagnosis.disease } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { appointment_id: @diagnosis.appointment_id, disease: @diagnosis.disease } }
