...
class WardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ward" do
    assert_difference('Ward.count') do
      post wards_url, params: { ward: { doctor_id: @ward.doctor_id, name: @ward.name, user_id: @ward.user_id } }
    end
  ...
  test "should update ward" do
    patch ward_url(@ward), params: { ward: { doctor_id: @ward.doctor_id, name: @ward.name, user_id: @ward.user_id } }
