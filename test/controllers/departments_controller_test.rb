...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { doctor_id: @department.doctor_id, name: @department.name, user_id: @department.user_id } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { doctor_id: @department.doctor_id, name: @department.name, user_id: @department.user_id } }
